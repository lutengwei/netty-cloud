...
public class WeChatConstants {
    ...
    //------------------------------------------------公众号------------------------------------------------
    //获取token
    public static final String API_TOKEN_URI = "cgi-bin/token";
    //微信公众号菜单创建
    ...
    //用户是否订阅该公众号标识
    public static final String WE_CHAT_GET_SUBSCRIBE_USER_INFO = "cgi-bin/user/info";
    ...
    //Js sdk api 列表
    public static final String PUBLIC_API_JS_API_SDK_LIST = "checkJsApi,updateTimelineShareData,updateAppMessageShareData,showMenuItems,hideAllNonBaseMenuItem,hideMenuItems,hideAllNonBaseMenuItem,chooseImage,uploadImage,getLocalImgData,downloadImage,scanQRCode";
    ...
    //授权请求地址
    public static final String WE_CHAT_AUTHORIZE_URL = "https://open.weixin.qq.com/connect/oauth2/authorize?appid={$appId}&redirect_uri={$redirectUri}&response_type=code&scope=snsapi_userinfo&state=#wechat_redirect";


    public static final byte[] lock = new byte[0];

    //微信是否发送通知标记
    public static final Map<Long,String> notifyMarkMap = new HashMap<Long,String>();


    //------------------------------------------------小程序------------------------------------------------

    //获取access_token
    public static final String WE_APPLET_ACCESS_TOKEN = "cgi-bin/token";
    //凭证校验
    public static final String WE_APPLETS_SESSION = "sns/jscode2session";
    //下发订阅消息
    public static final String WE_APPLET_SEND = "cgi-bin/message/subscribe/send";
